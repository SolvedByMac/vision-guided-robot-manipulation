...
dataset = ReachPoseDataset("data/reach_pose_control", "test")
...
with open("results/reach_pose_test_control_10k.json", "w") as file:
...
print("saved: results/reach_pose_test_control_10k.json")