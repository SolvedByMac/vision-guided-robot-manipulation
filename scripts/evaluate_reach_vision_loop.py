...
results = {
    ...
    "median_pose_error_m": float(
        np.median(pose_errors)
    ),
    "p90_pose_error_m": float(
        np.percentile(pose_errors, 90)
    ),
    "p95_pose_error_m": float(
        np.percentile(pose_errors, 95)
    ),
...
with open("results/reach_vision_loop_seed0.json", "w") as file:
...
print("saved: results/reach_vision_loop_seed0.json")